...
class Networks:
    ...
    Soneium = Network(
            ...
            api=API(key=config.HECO_API_KEY, url='glushka', docs='glushka')
    )
    ...
    APECHAIN = Network(
        ...
        api=API(key=config.HECO_API_KEY, url='https://apescan.io/', docs='https://hecoinfo.com/apis')
    )
...
class RawContract(AutoRepr):
    ...
    Attributes:
        ...
        proxy_address (ChecksumAddress | None): an optional proxy contract address.
    """

    title: str
    address: ChecksumAddress
    abi: list[dict[str, ...]]
    proxy_address: ChecksumAddress | None

    def __init__(self, address: str, abi: list[dict[str, ...]] | str | None = None, proxy_address: str | None = None, title: str = '') -> None:
        """
        ...
        Args:
            ...
            abi (Union[List[Dict[str, Any]], str, None]): an ABI of the contract.
            proxy_address (str | None): an optional proxy address.
        """
        self.title = title
